...
void cMap::generate()
{
	...
	bool *is_water = new bool[grid_size.x * grid_size.y];	//Tablica odpowiadaj¹ca za to, czy w danym punkcie znajduje siê woda - dziêki temu mo¿na zoptymalizowaæ generowanie obiektów w poziomie
